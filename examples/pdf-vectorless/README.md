...
## Run
```bash
python examples/pdf-vectorless/example.py
```
Uses the same `examples/handbook.pdf` as the PDF RAG demo (auto-created if missing).
...
## Compare
Run [examples/pdf-rag/example.py](../pdf-rag/) to answer the **same PDF and
